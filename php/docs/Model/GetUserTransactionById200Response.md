...
**infraction** | [**\OpenAPI\Client\Model\GetUserTransactionById200ResponseAllOfInfractionInner[]**](GetUserTransactionById200ResponseAllOfInfractionInner.md) | Histórico completo de infrações desta transação. | [optional]
