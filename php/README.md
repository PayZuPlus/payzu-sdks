...
*ReportsApi* | [**getUserReport**](docs/Api/ReportsApi.md#getuserreport) | **GET** /user/report/{id} | List report job status
...
- [TransactionInfraction](docs/Model/TransactionInfraction.md)
