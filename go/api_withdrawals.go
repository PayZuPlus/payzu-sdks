...
func (r ApiGetPixKeyRequest) ContentType(contentType string) ApiGetPixKeyRequest {
...
// Obrigatório em toda chamada PayZu.
func (r ApiGetWithdrawRequest) ContentType(contentType string) ApiGetWithdrawRequest {
	r.contentType = &contentType
	return r
}
...
// Obrigatório em toda chamada PayZu.
func (r ApiGetWithdrawProofRequest) ContentType(contentType string) ApiGetWithdrawProofRequest {
	r.contentType = &contentType
	return r
}
...
func (r ApiGetWithdrawProofRequest) Execute() (*GetProof200Response, *http.Response, error) {
...
func (a *WithdrawalsAPIService) GetWithdrawProofExecute(r ApiGetWithdrawProofRequest) (*GetProof200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
