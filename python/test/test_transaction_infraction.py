...
class TestTransactionInfraction(unittest.TestCase):
    """TransactionInfraction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionInfraction:
        """Test TransactionInfraction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionInfraction`
        """
        model = TransactionInfraction()
        if include_optional:
    ...
    def testTransactionInfraction(self):
        """Test TransactionInfraction"""
