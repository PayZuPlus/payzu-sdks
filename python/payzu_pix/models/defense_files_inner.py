...
class DefenseFilesInner(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description="URL assinada para download (expira em 9 minutos). Presente apenas ao buscar a defesa individual; ausente na listagem.")
